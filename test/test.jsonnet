local alphabetic = import '../jsonnet/keyboard/alphabetic_26_portrait.jsonnet';
local emoji = import '../jsonnet/keyboard/emoji_portrait.jsonnet';
local numericLandscape = import '../jsonnet/keyboard/numeric_9_landscape.jsonnet';
local numericPortrait = import '../jsonnet/keyboard/numeric_9_portrait.jsonnet';
local panel = import '../jsonnet/keyboard/panel.jsonnet';
local pinyin = import '../jsonnet/keyboard/pinyin_26_portrait.jsonnet';
local symbolic = import '../jsonnet/keyboard/symbolic_portrait.jsonnet';

local numericLandscape2 = import '../jsonnet/keyboard/numeric_9_landscape2.jsonnet';
